...
const FeatureItem = ({ title, number, description }) => (
  ...
  const LifeBenefitsSection = () => (
    <div className="life-benefits-section">
      ...
      <h2 className="section-subheading">Why Improving Every Aspect of Life Matters</h2>
        <p>Improving all aspects of life is key to a fulfilling and balanced existence. By focusing on sleep, fitness, and overall wellbeing, you can enhance your quality of life, increase your energy levels, and foster a positive mindset. MindJourney provides the tools you need to embark on this holistic journey towards better health and happiness.</p>
      </div>
    </div>
  );
  ...
  const WellbeingScoreSection = () => (
    <div className="wellbeing-score-section">
      ...
      <p>
        At MindJourney, we calculate your weekly Wellbeing Score by analyzing three key aspects of your life:
        fitness activities, sleep patterns, and overall wellbeing practices. Our algorithm takes into account 
        the frequency and quality of your workouts, the duration and consistency of your sleep, and your 
        engagement with mindfulness and stress-reduction activities. By combining these crucial elements, 
        we provide you with a comprehensive score that reflects your overall wellness. This score helps you 
        track your progress, identify areas for improvement, and motivate you to maintain a balanced, 
        healthy lifestyle.
      </p>
      ...
      <div className="homepage-content">
        <div className="content-wrapper">
          ...
          <p className="description">
            ...
            by providing you with the tools you need to track your progress and make meaningful 
            changes. Our website allows you to track sleep, fitness, and wellbeing features to help 
            you achieve your goals. With MindJourney, you will have the support you need to take control 
            of your life.
          </p>
